...
public class GeoController {
    ...
    @Autowired
    private PersonnelInformationServiceImpl personnelInformationService;
    ...
    public String index(){
        ...
        ArrayList<CityCoordinates> list = new ArrayList<>();
        for (Geo geo : geos) {
            ...
            list.add(cityCoordinates);
        }
        cityCoordinatesService.inserCityCoordinates(list);
